/**
 * RiotPlan Core Type Definitions
 *
 * Canonical domain types for long-lived, stateful AI workflows (plans).
 * All packages in the riotplan ecosystem should import types from this package.
 */
