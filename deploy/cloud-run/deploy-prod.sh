...
RIOTPLAN_VERSION="${RIOTPLAN_VERSION:-latest}"
...
echo "Deploying @kjerneverk/riotplan version: ${RIOTPLAN_VERSION}"
...
gcloud builds submit "${SCRIPT_DIR}" \
  ...
  --substitutions="_REGION=${REGION},_SERVICE_NAME=${SERVICE_NAME},_AR_REPO=${AR_REPO},_IMAGE_NAME=${IMAGE_NAME},_SERVICE_ACCOUNT=${SERVICE_ACCOUNT},_ENV_VARS_FILE=$(basename "${ENV_FILE}"),_OPENAI_SECRET=${OPENAI_SECRET},_RIOTPLAN_VERSION=${RIOTPLAN_VERSION},_REQUEST_TIMEOUT=${REQUEST_TIMEOUT},_MIN_INSTANCES=${MIN_INSTANCES}"
